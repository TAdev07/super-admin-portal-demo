...
import { createPostMessageBus } from '../../shared/eventBus'
import { setupShellSso } from '../../shared/sso'
...
export default function IframeHost({ appId, src, allowedOrigin, requestedScopes, className, style }: IframeHostProps) {
